...
function preload() {
  bg = loadImage("gamingbackground2.jpeg");
}

function setup() {
  createCanvas(1600, 610);
  ...
  box111 = new Box(500,100,70,70);
  box222 = new Box(500,100,70,70);
  box333 = new Box(500,100,70,70);
  box444 = new Box(500,100,70,70);
  box555 = new Box(500,100,70,70);
